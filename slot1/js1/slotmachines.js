...
async function meccanismo(){
    ...
    if(check == 0){
        ...
        if(moneytot < betsizeselected){
            ...
            $.ajax({
                url: "/spin",
                data: {userbetsize: betsizeselected, slottype: 1},
                ...
                success:async function(result){
                    ...
                    document.getElementById("winspace").innerHTML = "<img id='winimage' src='img1/cyan.png' width='95%' height='80%' draggable='false'>";
                    ...
                    for(let conta = 0; conta < 33; conta++){
                        if(conta < 25){
                            ...
                            document.getElementById("space1").innerHTML = "<img src='img1/" + num1 + ".png'' width='100%' height='100%' draggable='false'>";
                            //console.log("num1: "+num1);
                            if(conta == 24){
                                document.getElementById("space1").innerHTML = "<img src='img1/" + result.first + ".png'' width='100%' height='100%' draggable='false'>";
                        ...
                        if(conta < 28){
                            ...
                            document.getElementById("space2").innerHTML = "<img src='img1/" + num2 + ".png' ' width='100%' height='100%' draggable='false'>";
                        // console.log("num2: "+num2);
                            if(conta == 27){
                                document.getElementById("space2").innerHTML = "<img src='img1/" + result.second + ".png'' width='100%' height='100%' draggable='false'>";
                        ...
                        document.getElementById("space3").innerHTML = "<img src='img1/" + num3 + ".png' ' width='100%' height='100%' draggable='false'>";
                        //console.log("num3= "+num3);
                        if(conta == 32){
                            document.getElementById("space3").innerHTML = "<img src='img1/" + result.third + ".png'' width='100%' height='100%' draggable='false'>";
                    ...
                    if(num1 == num2 && num2 == num3){
                        ...
                        document.getElementById("winspace").innerHTML = "<img id='winimage' src='img1/jackpot.png'  width='95%' height='80%' draggable='false'>";
                        console.log("win");
...
async function autoroll(){
    ...
    if(checkauto == 1){
        checkauto = 0;
        document.getElementById("autorollimg").src="img1/autorollbutton.png";
    }
    else if(checkauto == 0){
        checkauto = 1;
        document.getElementById("autorollimg").src="img1/autorollpressed.png";
    }
    ...
    console.log(useridjs);
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                num1 = Math.floor(Math.random() * 16) + 1;
                document.getElementById("space1").innerHTML = "<img src='/slot1/img1/" + num1 + ".png'' width='100%' height='100%' draggable='false'>";
                num2 = Math.floor(Math.random() * 16) + 1;
                document.getElementById("space2").innerHTML = "<img src='/slot1/img1/" + num2 + ".png'' width='100%' height='100%' draggable='false'>";
                num3 = Math.floor(Math.random() * 16) + 1;
                document.getElementById("space3").innerHTML = "<img src='/slot1/img1/" + num3 + ".png'' width='100%' height='100%' draggable='false'>";
